...
@section('title', 'Data Ruang Pendadaran')
<div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        <form action="{{ route('ruangPendadaran.destroy', $value->id) }}" method="GET">
                                            @method('DELETE')
                                            @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="forms-sample" method="POST" name="eksport" id="eksport" action="{{route('ruangPendadaran.store')}}">
                    @csrf
...
<script>
    ...
    modal.find(".modal-body form").attr("action",'/data-ruang-pendadaran/update/'+id)
    })
</script>
@endsection
