        ...
        <div class="card card-primary">
            <form action="" method="GET" enctype="multipart/form-data" id="creatData">
                ...
                <div class="card-body">
                    ...
                    <a href=""
                    onclick="this.href='/yudisium/sk-yudisium/laporan/' + document.getElementById('periode_id').value"
                    target="_blank" id="btnSubmit" class="btn btn-gradient-primary "><i class="fa fa-print"></i>
                    Cetak SK</a>
                </div>
            </form>
        </div>
