                    ...
                    <table id="buttondatatable" class="table table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="badge badge-danger badge-pill ">Belum Mengajukan Data Tanggal Masuk</div>
                                </td>
                                @else
                                ...
                                @else
                                <td>
                                    <div class="badge badge-danger badge-pill ">Belum Mengajukan Data Nomer Alumni</div>
                                </td>
                                @endif
                                ...
                                @else
                                <td>
                                    <div class="badge badge-danger badge-pill ">Belum Mengajukan Data Pendadaran</div>
                                </td>
                                @endif
                                ...
                                @else
                                <td>
                                    <div class="badge badge-danger badge-pill ">Belum Mengajukan Data Yudisium</div>
                                </td>
                                @endif
                                <td>{{ $value->mahasiswa->Jurusan->namaJurusan }}</td>
                                @if ($value->mahasiswa->sks == Null)
                                <td>
                                    <div class="badge badge-danger badge-pill ">Belum Mengajukan Data SKS</div>
                                </td>
                                @else
                                ...
                                @else
                                <td>
                                    <div class="badge badge-danger badge-pill ">Belum Tersedia Data Lama Studi</div>
                                </td>
                                @endif
                                ...
                                @else
                                <td>
                                    <div class="badge badge-danger badge-pill ">Belum Mengajukan Data Predikat Kelulusan</div>
                                </td>
                                @endif
                                <td>
                                    <div class="btn-group">
